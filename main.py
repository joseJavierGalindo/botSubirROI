...
def onmessage(update,bot:ObigramClient):
    try:
        ...
        if '/start' in msgText:
            start_msg = 'Bot          :🌐𝙈𝙔_𝘽𝙊𝙏🌐 v7.1\n'
            start_msg+= 'Desarrollador: @onehondrew\n'
            ...
            #    
                # set in debug
            #    api_id = 16096319
            #    api_hash = '3605f30b6727cd38a08a3e92218dbe92'
            #    bot_token = '5216979526:AAFRcEAXI7ybCMxTN0UzMpDsk1bsTXB5-sU'
...
def main():
    ...
    #set in debug
    bot_token = '5362120635:AAFTUmO6qvyc8X4Ttq2cpBFWGyMaf9flZwo'
